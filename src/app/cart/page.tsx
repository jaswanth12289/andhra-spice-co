...
export default function CartPage() {
    const { items, updateQuantity, removeItem, getTotal, getDeliveryCharge, getFinalTotal } = useCartStore();
          ...
          <div className="bg-spice-50 dark:bg-spice-900 border border-spice-200 rounded-3xl p-8 h-fit shadow-sm sticky top-24">
            ...
            <div className="flex justify-between mb-8 text-lg">
              ...
              {getDeliveryCharge() === 0 ? (
                ...
                <span className="font-bold text-spice-600 dark:text-spice-400 font-mono">₹{getDeliveryCharge()}</span>
              )}
            </div>
